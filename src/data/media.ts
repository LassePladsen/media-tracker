...
> = {
  bg: {
    all: "",
    "plan-to-watch": "", // TODO:
    watching: "bg-blue-950 text-blue-400 border-blue-800",
    ...
    rewatching: "bg-cyan-950 text-cyan-400 border-cyan-800", // TODO:
  },
  fg: {
    // Comment styles are so tailwind loads them in when using dynamic classnames...
    all: "",
    "plan-to-watch": "", // TODO:
    watching: "text-blue-400", // hover:text-blue-400
    ...
    rewatching: "text-cyan-400", // hover:text-cyan-400
  },
};
